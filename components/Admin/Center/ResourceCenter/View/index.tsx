...
const ViewResourceCenter = ({ data }: Props) => {
  // const router = useRouter()
  // const { id } = router.query
  // console.log(id);
  // const { data: Learningcentertype } = useShowLearningCenterQuery(id)
  // console.log('showlearningCenter', Learningcentertype);
          ...
          <Box >
            <List >
              ...
              <ListItem>
                ...
                </Typography><Typography component="span" className="details">{data?.resourcecentertypeId.name_bn}</Typography></ListItemText>
              </ListItem>
              <ListItem>
                <ListItemText><Typography component="span" className="label">
...
export default ViewResourceCenter