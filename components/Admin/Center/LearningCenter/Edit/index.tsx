                ...
                <Grid container spacing={2.5}>
                  ...
                  <Grid item xs={12} md={6} lg={4}>
                    <FormInputLabel htmlFor="name_bn" required={true}>
                      {translate(langData, lang, LangSetUpForCenter.list.centerName.key) + translate(langData, lang, LangSetUpForForm.bangla.key) || "মসজিদ/কেন্দ্রের নাম (বাংলা)"}
                    </FormInputLabel>
                    <FormInputBootstrap name='name_bn' id="name_bn" />
                  </Grid>
                  <Grid item xs={12} md={6} lg={4}>
                    <FormInputLabel htmlFor="name_en" required={true}>
                      {translate(langData, lang, LangSetUpForCenter.list.centerName.key) + translate(langData, lang, LangSetUpForForm.english.key) || "মসজিদ/কেন্দ্রের নাম (ইংরেজি)"}
                    </FormInputLabel>
                    ...
                    <Box className="submitBtnField">
                      <Box className="stuRightBtn">
                        <Box className="addBtn">
                          <Button type="submit"> + {translate(langData, lang, LangSetUpForForm.update.key) || "হালনাগাদ করুন"}</Button>
                        </Box>
                      </Box>
                    </Box>
                  </Grid>
